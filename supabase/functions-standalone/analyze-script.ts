// analyze-script — versione a FILE SINGOLO (per incollare direttamente
// nell'editor della Dashboard Supabase, senza gestire l'import condiviso).
// Sorgente "vera" e mantenuta: supabase/functions/analyze-script/index.ts
//
...
// thumb_text_providers, quindi cambiare motore è un click in Impostazioni,
