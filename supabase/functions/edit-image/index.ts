...
// Motore GRATUITO di default: Hugging Face, modello image-to-image
// (istruzione testuale su un'immagine di input, es. instruct-pix2pix).
// Qualità/affidabilità inferiore ai provider a pagamento — cambiabile in
// qualsiasi momento da Impostazioni → Motori AI.
...
// fal.ai — default: Flux Kontext, pensato apposta per editing via testo di
// un'immagine esistente (a differenza di instant-id usato in generazione).
...
// Replicate — modello/versione configurabile (es. black-forest-labs/flux-kontext-pro).
